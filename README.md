...
### vs 競合ツール（tsumugi / Jasper / Copy.ai / Notion AI）

| 特徴 | Note Agent AI | 競合ツール |
|------|---------------|-----------|
| **統合リサーチ** | ✅ Google/note/SNS/Reddit統合 + RAG | ❌ 基本的な検索のみ |
| **note特化最適化** | ✅ アルゴリズム理解に基づく最適化 | ❌ 汎用的 |
| **AIっぽくないライティング** | ✅ 体験談挿入、翻訳調排除 | △ 機械的な文章 |
| **マルチモーダル** | ✅ 図解自動生成（Mermaid.js） | △ 画像生成のみ |
| **SNS展開統合** | ✅ X/Threads等マルチプラットフォーム | ❌ 別途手動対応 |
| **複数バージョン生成** | ✅ A/Bテスト対応 | ❌ 単一バージョンのみ |
| **日本語特化** | ✅ Gemini 2.5の高度な処理 | △ 英語優先 |
| **コラボレーション** | ✅ リアルタイム共同編集（Phase 2.5） | △ 限定的 |
