...
※生成された内容の正確性は保証されません。公開前に必ず内容を確認・修正してください。
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md space-y-6">
            <h2 className="text-2xl font-bold text-gray-800 border-b pb-2">生成結果</h2>
            
            <div>
                <h3 className="text-lg font-semibold text-gray-700 mb-2">アイキャッチ画像</h3>
                <img src={output.imageUrl} alt="Generated eyecatch" className="w-full h-auto object-cover rounded-md shadow-lg" />
                 <a href={output.imageUrl} download="eyecatch.png" className="mt-2 inline-block bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded transition-colors">
                    画像をダウンロード
                </a>
            </div>
            ...
            <div>
                 <div className="flex justify-between items-center mb-2">
                    <h3 className="text-lg font-semibold text-gray-700">メタディスクリプション</h3>
                    <button 
            ...
            <div>
                 <div className="flex justify-between items-center mb-2">
                    <h3 className="text-lg font-semibold text-gray-700">記事本文 (Markdown)</h3>
                    <button 
                ...
                <pre className="bg-gray-50 p-4 rounded-md border border-gray-200 text-sm overflow-x-auto max-h-96">
                    <code>{output.markdownContent}</code>
                </pre>
            </div>

             <div>
                <h3 className="text-lg font-semibold text-gray-700 mb-2">利用ガイド</h3>
                 <div className="bg-gray-50 p-4 rounded-md border border-gray-200 text-sm">
